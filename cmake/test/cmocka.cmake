...
#
# You can link against the `cmocka_dep` library to access the dependency in an agnostic
# manner.
#
# This module also provides a `test-clear-results` target which can be used to clear
# existing XML files, since CMocka will not save XML data if the files already exist.
#
...
# of CMocka test programs. Call this function with the desired test name and the build
...
if(NOT CMOCKA_TEST_OUTPUT_DIR)
    set(CMOCKA_TEST_OUTPUT_DIR ${CMAKE_BINARY_DIR}/test/ CACHE
        STRING "Location where CMocka test results should live.")
endif()
######################
# Satisfy Dependency #
######################
