...
#
# Argument 1 is a comma-separated list of directores to search for files in
#       e.g.: src,include
#       This is required
# Argument 2 is a comma-separated list of file types to search for
#       e.g.: *.c,*.h,*.cpp,*.hpp
#       This is required
#
# Optional arguments:
# -e specifies a comma-separated list of directories to exclude
#       e.g.: -i src/gdtoa,src/external
# -p generates a patch file using `git diff`
#
## NOTE: Due to getopts limitations, optional arguments must precede positoinal arguments
#
...
# Parse $EXCLUDES_ARGS into the exclude arguments
EXCLUDES=
