...
This project is [hosted on GitHub](https://github.com/pizzyflavin/PROJECT). You can clone this project directly using this command:

```
git clone git@github.com:pizzyflavin/PROJECT.git
```
...
* **[Ricky Rininger](https://github.com/pizzyflavin)** - *Initial work* - [ORGANIZATION](https://github.com/ORGANIZATION)
